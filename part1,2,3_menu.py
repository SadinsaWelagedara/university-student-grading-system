...
def menu():                               #creating a function to deicde student or staff
    global countProgress
    global countTrailer
    global countExclude
    global countMretriever
    ...
    #Part C - Multiple outcomes
        ...
        if choise == 2:           #if user input staff
            while True:
...
#creating the menu to decide whether student or staff
while True:
    try:
        choise = int(input("Enter '1' for the student enter '2' for the staff\nEnter your choise :"))
